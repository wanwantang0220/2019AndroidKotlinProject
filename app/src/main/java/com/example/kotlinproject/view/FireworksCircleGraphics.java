...
//    private static int traceCount = 0;
    ...
    FireworksCircleGraphics(Context context) {
        ...
        lineMaxDxy = UtilsJava.dp2px(context, LINE_MAX_DR);
        lineMaxDr = UtilsJava.dp2px(context, LINE_MAX_DC);
        lineMaxChangeRate = UtilsJava.dp2px(context, LINE_MAX_CHANGE_RATE);
        lineDecayRate = UtilsJava.dp2px(context, LINE_DECAY_RATE);
        lineRectF = new RectF(0, 0, 0, 0);

        /* 星星大小 px */
        float starSize = UtilsJava.dp2px(context, STAR_SIZE);
        starMaxVx = UtilsJava.dp2px(context, STAR_MAX_VX);
        starMaxVy = UtilsJava.dp2px(context, STAR_MAX_VY);
        starDecayRate = UtilsJava.dp2px(context, STAR_DECAY_RATE);
        starDecayRateConst = UtilsJava.dp2px(context, STAR_DECAY_RATE_CONST);
        starDisappearDistance = UtilsJava.dp2px(context, STAR_DISAPPEAR_DISTANCE);
        ...
        linePaint.setStrokeWidth(UtilsJava.dp2px(context, LINE_SIZE));
