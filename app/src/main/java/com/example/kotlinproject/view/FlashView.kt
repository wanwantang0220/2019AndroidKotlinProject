...
class FlashView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    //合成图片画笔
    private var mDstPaint: Paint
    //原始图片画笔
    private var mSrcPaint: Paint
    //原始图片
...
//    private var mStartAlpha = 130
    ...
    init {
        ...
        mSrcBitmap = BitmapFactory.decodeResource(resources, R.drawable.flash)
    }
...
//        }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // 绘制源图
        canvas.drawBitmap(mSrcBitmap!!, 0f, 0f, mSrcPaint)
        ...
        mRenderMaskBitmapCanvas!!.drawBitmap(mSrcBitmap!!, 0f, 0f, null)
        ...
        if (mMaskBitmap == null) {
            ...
            val shader = LinearGradient(
                ...
                0.65f * horMoveArea,
                0.0f * verMoveArea,
                this.mStartColor, this.mEndColor, Shader.TileMode.CLAMP)
